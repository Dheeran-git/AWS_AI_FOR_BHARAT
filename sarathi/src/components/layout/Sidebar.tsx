...
export function Sidebar() {
  ...
  return (
    <aside
      className="w-60 bg-white border-r border-slate-100 h-screen flex flex-col fixed top-0 left-0 z-30"
    ...
    >
      ...
      {user && (
        <div className="px-5 py-4 border-b border-slate-100">
          ...
          {user.panchayatName && (
            <p className="text-xs text-slate-500 truncate mt-0.5">{user.panchayatName}</p>
          )}
        </div>
      )}
      ...
      {/* Performance pill */}
      <div className="mx-3 mb-3 p-4 bg-[#1e3a5f]/5 rounded-xl border border-[#1e3a5f]/10">
